...
export class DeviceSimService {
  ...
  constructor(public http: HttpClient) { this.mySim1 = this.mySimSubject.asObservable(); }
  ...
  getPromData(): any {
    ...
    const tempQuery: string = '/query_range?query=device_connected_status{site="freemont", iccid="123-456-781"}&start=2021-12-27T13:42:00.000Z&end=2021-12-28T13:42:00.000Z&step=60m'
